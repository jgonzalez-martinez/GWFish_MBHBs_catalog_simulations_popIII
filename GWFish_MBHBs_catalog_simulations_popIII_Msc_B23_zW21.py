...
from catalog_MBHBs_popIII_Msc_B23_zW21 import N_drawn, generate_synthetic_MBHB_population 
...
gw.fishermatrix.analyze_and_save_to_txt(network = network,
                                        ...
                                        population_name = f'MBHB_catalog_popIII_withfisher_tilts_Msc_B23_zW21_PhenomPv2',
                                        waveform_model = waveform_model,
                                        f_ref = 1e-4,
